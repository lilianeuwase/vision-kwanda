      ...
      <div className="flex flex-col max-w-screen-lg overflow-hidden bg-gray-200 border rounded shadow-sm lg:flex-row sm:mx-auto">
        ...
        <div className="flex flex-col justify-center p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2">
          ...
          >
            ...
            has been established as the company operating in our regional area
            and to the extent of global scale. Our business model is based on
            providing mining engineering services towards professionalizing
            mining industry.
          </motion.p>
